...
window.SWAPPI = (() => {
  const skills = [
    { id: 1, title: "Conversational Arabic — Egyptian Dialect", cat: "Language", catColor: "orange",
      provider: "Yasmin H.", initials: "YH", price: 45, swap: "Web design", rating: 4.9, reviews: 142, mode: "Online · 1:1",
    ...
    { id: 2, title: "Film photography on a budget", cat: "Creative", catColor: "blue",
      provider: "Karim S.", initials: "KS", price: 60, swap: "Excel modeling", rating: 4.8, reviews: 88, mode: "In-person · Cairo",
    ...
    { id: 3, title: "Build your first Figma plugin", cat: "Tech", catColor: "blue",
      provider: "Mara T.", initials: "MT", price: 75, swap: "Anything design", rating: 5.0, reviews: 64, mode: "Online · Small group",
    ...
    { id: 4, title: "Pottery wheel — beginner basics", cat: "Craft", catColor: "orange",
      provider: "Omar L.", initials: "OL", price: 50, swap: "Cooking lessons", rating: 4.7, reviews: 211, mode: "In-person · Studio",
    ...
    { id: 5, title: "Public speaking that doesn't feel fake", cat: "Career", catColor: "blue",
      provider: "Reem A.", initials: "RA", price: 90, swap: null, rating: 4.9, reviews: 173, mode: "Online · 1:1",
    ...
    { id: 6, title: "Bread-baking from scratch", cat: "Cooking", catColor: "orange",
      provider: "Hana M.", initials: "HM", price: 40, swap: "Yoga", rating: 4.8, reviews: 96, mode: "In-person · Kitchen",
    ...
    { id: 7, title: "Intro to product strategy", cat: "Career", catColor: "blue",
      provider: "Dina F.", initials: "DF", price: 110, swap: "Copywriting", rating: 4.9, reviews: 58, mode: "Online · 1:1",
    ...
    { id: 8, title: "Watercolor portraits", cat: "Creative", catColor: "orange",
      provider: "Nour B.", initials: "NB", price: 55, swap: "Spanish lessons", rating: 4.7, reviews: 124, mode: "In-person · Studio",
    ...
    { id: 9, title: "SQL for analysts who hate SQL", cat: "Tech", catColor: "blue",
      provider: "Sami R.", initials: "SR", price: 70, swap: "Marketing", rating: 4.8, reviews: 41, mode: "Online · Small group",
    ...
    { id: 10, title: "Mindful running, no garmin needed", cat: "Wellness", catColor: "orange",
      provider: "Lina K.", initials: "LK", price: 35, swap: "French lessons", rating: 4.9, reviews: 187, mode: "In-person · Park",
    ...
    { id: 11, title: "Pitch decks that land funding", cat: "Career", catColor: "blue",
      provider: "Tarek Z.", initials: "TZ", price: 130, swap: null, rating: 5.0, reviews: 36, mode: "Online · 1:1",
    ...
    { id: 12, title: "Beginner DJ — Ableton & beatmatching", cat: "Music", catColor: "orange",
      provider: "Adam P.", initials: "AP", price: 80, swap: "Video editing", rating: 4.8, reviews: 72, mode: "In-person · Studio",
  ...
  const workshops = [
    { title: "Cairo Sketch Crawl", host: "Nour B.", date: "Sat, May 18", time: "10am–1pm", seats: 12, taken: 9, price: 25, location: "Downtown Cairo",
      img: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=700&h=420&q=80&auto=format&fit=crop" },
    { title: "Intro to Sourdough", host: "Hana M.", date: "Sun, May 19", time: "9am–12pm", seats: 8, taken: 6, price: 40, location: "Maadi Kitchen Co-op",
      img: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=700&h=420&q=80&auto=format&fit=crop" },
    { title: "Negotiation for Designers", host: "Dina F.", date: "Wed, May 22", time: "7pm–9pm", seats: 30, taken: 14, price: 30, location: "Online",
      img: "https://images.unsplash.com/photo-1557804506-669a67965ba0?w=700&h=420&q=80&auto=format&fit=crop" },
    { title: "Vinyl DJ basics", host: "Adam P.", date: "Fri, May 24", time: "8pm–11pm", seats: 10, taken: 7, price: 60, location: "Garden City Studio",
      img: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=700&h=420&q=80&auto=format&fit=crop" },
    { title: "Pitch your side project", host: "Tarek Z.", date: "Sat, May 25", time: "2pm–5pm", seats: 20, taken: 11, price: 35, location: "Online",
      img: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=700&h=420&q=80&auto=format&fit=crop" },
    { title: "Pottery for total beginners", host: "Omar L.", date: "Sun, May 26", time: "11am–2pm", seats: 6, taken: 5, price: 55, location: "Heliopolis Studio",
